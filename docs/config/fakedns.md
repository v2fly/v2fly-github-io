...
虚拟 DNS 服务器分配 IP 的地址空间。由虚拟 DNS 服务器分配的地址会符合这个 CIDR 表达式。默认 "240.0.0.0/8"。也支持 IPv6，例如 "fc00::/7"。
...
虚拟 DNS 是解决这个 DNS 污染，防止 DNS 信息泄露，又能减低延时的技术手段。 [RFC3089](https://tools.ietf.org/html/rfc3089) 
